...
public class SharedPrefUtil {
    ...
    public void createSession(String userName,String password,String userEmail){
    ...
    public User getUserInfo(){
        return new User(sharedPreferences.getString(USER_NAME,null),sharedPreferences.getString(USER_EMAIL,null),sharedPreferences.getString(USER_PASSWORD,null),null);
    }
